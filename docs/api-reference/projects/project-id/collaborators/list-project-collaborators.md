...
```http
GET {{baseUrl}}/projects/:project_id/collaborators?affiliation=all&per_page=30&page=1
```
...
| `affiliation` | `string` | `Query` | `No` | Filters the collaborators by their affiliation. Can be one of:  
