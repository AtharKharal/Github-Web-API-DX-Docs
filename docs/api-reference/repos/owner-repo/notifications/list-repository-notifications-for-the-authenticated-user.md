...
| `all` | `string` | `Query` | `No` | If `true`, show notifications marked as read. |

| `participating` | `string` | `Query` | `No` | If `true`, only shows notifications in which the user is directly participating or mentioned. |
